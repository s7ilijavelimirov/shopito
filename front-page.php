    ...
    <div class="container px-0">
        <div id="features" class="custom-product-slider" data-visible-items="3">
                            ...
                            <a href="<?php echo esc_url($product_permalink); ?>">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <?php if ($sku) : ?>
                                            <p class="product-sku">Model: <?php echo $sku; ?></p>
                                        <?php endif; ?>
                                        <?php
                                        if ($sale_price) {
            ...
            <div class="custom-product-slider-controls">
                <button class="custom-product-slider-prev"><i class="fa-solid fa-angle-left"></i></button>
                <button class="custom-product-slider-next"><i class="fa-solid fa-angle-right"></i></button>
            </div>
